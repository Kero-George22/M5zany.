...
public class ProductAnalysisController extends VBox {
    ...
    private void initializeUI() {
        ...
        filterBox.setStyle("-fx-background-color: #1e1e2e; -fx-background-radius: 8; -fx-border-color: #333; -fx-border-width: 1;");
        ...
        slowMovingBox.setStyle("-fx-background-color: #1e1e2e; -fx-background-radius: 8; -fx-border-color: #e65100; -fx-border-width: 1;");
        ...
        lossMakingBox.setStyle("-fx-background-color: #1e1e2e; -fx-background-radius: 8; -fx-border-color: #c62828; -fx-border-width: 1;");
