...
public class UserManagementController extends VBox {
    ...
    public UserManagementController(AuthService authService, Stage stage) {
        ...
        // Main content: table + form (scrollable) fills all space
    ...
    private void buildFormCard(VBox parent) {
        ...
        formGrid.setPadding(new Insets(10, 0, 5, 0));

        // Buttons are defined in buildButtonFooter() — added after scroll
    ...
    private HBox buildButtonFooter() {
        ...
        HBox footer = new HBox(16, saveBtn, deleteBtn, resetPasswordBtn, clearBtn);
